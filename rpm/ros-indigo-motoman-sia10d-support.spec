Name:           ros-indigo-motoman-sia10d-support
Version:        0.3.5
Release:        0%{?dist}
Summary:        ROS motoman_sia10d_support package

Group:          Development/Libraries
License:        BSD
URL:            http://ros.org/wiki/motoman_sia10d_support
...
%description
ROS Industrial support for the Motoman sia10d (and variants). This package
contains configuration data, 3D models and launch files for Motoman sia10d
manipulators. Specifications sia10d - Default Joint limits and maximum joint
velocities are based on the information found in the online
http://www.motoman.com/datasheets/sia10d.pdf All urdfs are based on the default
