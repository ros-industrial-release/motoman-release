Name:           ros-indigo-motoman-sda10f-support
Version:        0.3.7
Release:        0%{?dist}
Summary:        ROS motoman_sda10f_support package

Group:          Development/Libraries
License:        BSD
URL:            http://ros.org/wiki/motoman_sda10f_support
...
%description
ROS Industrial support for the Motoman sda10f (and variants). This package
contains configuration data, 3D models and launch files for Motoman sda10f
manipulators. Specifications sda10f - Default Joint limits and maximum joint
velocities are based on the information found in the online
http://www.motoman.com/datasheets/sda10f.pdf All urdfs are based on the default
